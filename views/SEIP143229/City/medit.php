                ...
                <div class="form-bottom">
                    <form role="form" action="update.php" method="post" class="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="your_city" value="<?php echo $oneData->name; ?>" class="form-booktitle form-control" id="form-booktitle">
                        </div>
                        <div class="form-group">
                            <label class="sr-only" for="form-author">City</label>
                            <input type="text" name="your_city" value="<?php echo $oneData->city; ?>" class="form-author form-control" id="form-author">
                        </div>
