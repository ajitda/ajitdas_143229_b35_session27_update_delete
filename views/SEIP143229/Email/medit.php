            ...
            <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="form-bottom">
                    <form role="form" action="update.php" method="post" class="login-form">
                        ...
                        <div class="form-group">
                            <label class="sr-only" for="form-author">Email</label>
                            <input type="email" name="your_email" value="<?php echo $oneData->email; ?>" class="form-author form-control" id="form-author">
                        </div>
