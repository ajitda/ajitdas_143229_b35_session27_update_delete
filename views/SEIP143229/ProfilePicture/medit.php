            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-top">
                    <div class="form-top-left">
                        ...
                        <p>Enter your Name and Select your Profile Picture:</p>
                    </div>
                ...
                <div class="form-bottom">
                    <form role="form" action="update.php" method="post" class="login-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="form-author">Select your Profile Picuture</label>
                            <input type="file" name="fileUpload"  value="<?php echo $oneData->file_path; ?>" class="form-author form-control" id="form-author">
                        </div>
                       <?php echo "<img src='../../../resources/assets/img/".$oneData->file_path."' >"; ?>
                        </div>
